...
describe('L-System with Array productions', function () {
...
describe('Parametric L-Systems: custom Objects as symbols with function productions', function () {
  ...
  it('Basic (normalized) parametric L-System structure should be useable with classic context sensitive syntax and return matched symbol objects. Manipulation of other symbols inside productions should (and can) only work for right side, as left side is already processed.', function() {
...
describe('L-Systems with Object based productions', function() {
  ...
  it('condition be able to utilize parameters', function() {
    ...
    lsystem.setProduction('F', { condition: (part) => part.params[0], successor: 'FF'});

    expect(lsystem.getString()).to.equal('FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF');
  });
